...
const EXERCISE_DB = [
  ...
  {id:'dips-assisted', name:'Assisted Dips', muscle:'chest', icon:'💪', type:'strength', met:4.5, assisted:true, videoUrl:'https://www.youtube.com/watch?v=P9CkuhCc0TE'},
  {id:'pec-deck', name:'Pec Deck Machine', muscle:'chest', icon:'🏋️', type:'strength', met:4.0},
  {id:'chest-press-machine', name:'Chest Press Machine', muscle:'chest', icon:'🏋️', type:'strength', met:4.5, videoUrl:'https://www.youtube.com/watch?v=pLofEAcfsO8'},
  ...
  {id:'pull-up-assisted', name:'Assisted Pull-Up', muscle:'back', icon:'💪', type:'strength', met:5.5, assisted:true, videoUrl:'https://www.youtube.com/watch?v=wFj808u2HWU'},
  {id:'lat-pulldown', name:'Lat Pulldown', muscle:'back', icon:'🏋️', type:'strength', met:5.0, videoUrl:'https://www.youtube.com/watch?v=Z_3xHwuO8Tk'},
  ...
  {id:'seated-cable-row', name:'Seated Cable Row', muscle:'back', icon:'🏋️', type:'strength', met:5.0, videoUrl:'https://www.youtube.com/watch?v=f_r95UajQcg'},
  ...
  {id:'leg-press', name:'Leg Press', muscle:'legs', icon:'🦵', type:'strength', met:5.0, videoUrl:'https://www.youtube.com/watch?v=ETOAyWM6i6A'},
  ...
  {id:'shoulder-press-machine', name:'Shoulder Press Machine', muscle:'shoulders', icon:'🏋️', type:'strength', met:4.5, videoUrl:'https://www.youtube.com/watch?v=TnhIyp4kmO8'},

  // ---- ARMS ----
  {id:'bicep-curl-barbell', name:'Barbell Bicep Curl', muscle:'arms', icon:'💪', type:'strength', met:3.5},
  {id:'bicep-curl-dumbbell', name:'Dumbbell Bicep Curl', muscle:'arms', icon:'💪', type:'strength', met:3.5, videoUrl:'https://www.youtube.com/watch?v=6DeLZ6cbgWQ'},
  ...
  {id:'tricep-pushdown', name:'Tricep Pushdown', muscle:'arms', icon:'💪', type:'strength', met:3.5, videoUrl:'https://www.youtube.com/watch?v=LXkCrxn3caQ'},
