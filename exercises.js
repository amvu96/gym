...
const EXERCISE_DB = [
  ...
  {id:'bench-press-dumbbell', name:'Dumbbell Bench Press', muscle:'chest', icon:'🏋️', type:'strength', met:5.0, bodyMap:['chest', 'triceps', 'shoulders']},
  {id:'incline-bench-press', name:'Incline Bench Press', muscle:'chest', icon:'🏋️', type:'strength', met:5.0, bodyMap:['chest', 'shoulders', 'triceps']},
  {id:'decline-bench-press', name:'Decline Bench Press', muscle:'chest', icon:'🏋️', type:'strength', met:5.0, bodyMap:['chest', 'triceps']},
  {id:'chest-fly-dumbbell', name:'Dumbbell Chest Fly', muscle:'chest', icon:'🏋️', type:'strength', met:4.5, bodyMap:['chest']},
  {id:'cable-crossover', name:'Cable Crossover', muscle:'chest', icon:'🏋️', type:'strength', met:4.5, bodyMap:['chest']},
  {id:'push-up', name:'Push-Up', muscle:'chest', icon:'💪', type:'bodyweight', met:3.8, bodyMap:['chest', 'triceps', 'shoulders']},
  {id:'dips-chest', name:'Chest Dips', muscle:'chest', icon:'💪', type:'bodyweight', met:5.5, bodyMap:['chest', 'triceps']},
  ...
  {id:'pec-deck', name:'Pec Deck Machine', muscle:'chest', icon:'🏋️', type:'strength', met:4.0, bodyMap:['chest']},
  ...
  {id:'pull-up', name:'Pull-Up', muscle:'back', icon:'💪', type:'bodyweight', met:8.0, bodyMap:['lats', 'biceps']},
  {id:'chin-up', name:'Chin-Up', muscle:'back', icon:'💪', type:'bodyweight', met:8.0, bodyMap:['lats', 'biceps']},
  ...
  {id:'dumbbell-row', name:'Single-Arm Dumbbell Row', muscle:'back', icon:'🏋️', type:'strength', met:5.5, bodyMap:['lats', 'upper_back', 'biceps']},
  ...
  {id:'mid-row', name:'Mid Row', muscle:'back', icon:'🏋️', type:'strength', met:5.0, bodyMap:['upper_back', 'lats']},
  {id:'t-bar-row', name:'T-Bar Row', muscle:'back', icon:'🏋️', type:'strength', met:5.5, bodyMap:['upper_back', 'lats', 'biceps']},
  {id:'face-pull', name:'Face Pull', muscle:'back', icon:'🏋️', type:'strength', met:3.5, bodyMap:['upper_back', 'shoulders']},
  {id:'hyperextension', name:'Back Extension', muscle:'back', icon:'💪', type:'bodyweight', met:4.0, bodyMap:['lower_back', 'glutes']},
  {id:'good-morning', name:'Good Morning', muscle:'back', icon:'🏋️', type:'strength', met:5.0, bodyMap:['lower_back', 'hamstrings', 'glutes']},
  {id:'shrugs', name:'Barbell Shrugs', muscle:'back', icon:'🏋️', type:'strength', met:3.5, bodyMap:['upper_back']},
  ...
  {id:'front-squat', name:'Front Squat', muscle:'legs', icon:'🦵', type:'strength', met:6.0, bodyMap:['quads', 'glutes']},
  ...
  {id:'lunges', name:'Walking Lunges', muscle:'legs', icon:'🦵', type:'bodyweight', met:5.0, bodyMap:['quads', 'glutes', 'hamstrings']},
  {id:'bulgarian-split-squat', name:'Bulgarian Split Squat', muscle:'legs', icon:'🦵', type:'strength', met:5.5, bodyMap:['quads', 'glutes', 'hamstrings']},
  {id:'leg-extension', name:'Leg Extension', muscle:'legs', icon:'🦵', type:'strength', met:4.0, bodyMap:['quads']},
  {id:'leg-curl', name:'Leg Curl', muscle:'legs', icon:'🦵', type:'strength', met:4.0, bodyMap:['hamstrings']},
